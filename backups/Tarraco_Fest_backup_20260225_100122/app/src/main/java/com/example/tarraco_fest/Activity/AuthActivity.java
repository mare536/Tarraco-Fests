...
public class AuthActivity extends AppCompatActivity {
    ...
    private boolean forceEmailLogin = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        forceEmailLogin = getIntent().getBooleanExtra(LandingActivity.EXTRA_FORCE_EMAIL_LOGIN, false);
        if (forceEmailLogin) {
            // Si viene desde "Continuar con email", limpiamos sesion previa.
            auth.signOut();
        }
